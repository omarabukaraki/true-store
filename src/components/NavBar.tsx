                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:flex place-items-center">
                                <div className="flex  space-x-4">
                                    ...
                                    <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-black hover:bg-gray-900 hover:text-white">Calendar</a>
                                </div>
                            </div>
                        </div>
                        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                            <button type="button" className="relative rounded-full p-1 border-2 border-gray-400 text-gray-500 hover:border-gray-900 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
